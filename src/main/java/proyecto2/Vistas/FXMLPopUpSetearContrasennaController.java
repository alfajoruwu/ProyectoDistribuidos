 ...
 * @author alfajor
 */
public class FXMLPopUpSetearContrasennaController implements Initializable {
    ...
    @FXML
    public void primeraContrasenna() throws IOException {
        if (nuevaClave.getText().equals(ConfirmarClave.getText())) {
            Mensaje<Object> mensaje = new Mensaje<Object>();
            mensaje.setEmisor(usuario);
            mensaje.setDestinatario(Constantes.TipoDestino.ACTUALIZAR_CONTRASENNA,
